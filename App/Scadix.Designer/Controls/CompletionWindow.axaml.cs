...
using Scadix.Designer.Controls;
using System;
...
internal partial class CompletionWindow : UserControl
{
    ...
    private void ShowDocumentationComments(CompletionDescription description, string documentationXml, double offset)
    {
        ...
        {
            VectSharp.Font labelFont = new VectSharp.Font(OpenSansRegular, this.FontSize);
            VectSharp.Font codeFont = new VectSharp.Font(RobotoMonoRegular, this.FontSize);
            ...
            Control unlimitedContent = Scadix.Designer.Controls.FormattedText.FormatDescription(description.TaggedParts, documentationXml, labelFont, codeFont).Render(double.PositiveInfinity, false);
            ...
            {
                Control content = Scadix.Designer.Controls.FormattedText.FormatDescription(description.TaggedParts, documentationXml, labelFont, codeFont).Render(maxWidthRight - 20 - 12, false);
            ...
            {
                Control content = Scadix.Designer.Controls.FormattedText.FormatDescription(description.TaggedParts, documentationXml, labelFont, codeFont).Render(maxWidthLeft - 20 - 12, false);
                content.HorizontalAlignment = Avalonia.Layout.HorizontalAlignment.Left;
                content.VerticalAlignment = Avalonia.Layout.VerticalAlignment.Top;
    ...
    public Microsoft.CodeAnalysis.Completion.CompletionList CompletionList { get; private set; }

    public async Task SetCompletionList(Microsoft.CodeAnalysis.Completion.CompletionList list)
    {
        UpdatingItems = true;
    ...
    public CompletionWindow()
    {
        ...
        RobotoMonoRegular = new VectSharp.ResourceFontFamily(typeof(CompletionWindow).Assembly.GetManifestResourceStream("Scadix.Designer.Fonts.Assets.RobotoMono-Regular.ttf"), "resm:Scadix.Designer.Fonts.Assets.?assembly=Scadix.Designer#Roboto Mono");

        OpenSansRegular = new VectSharp.ResourceFontFamily(typeof(CompletionWindow).Assembly.GetManifestResourceStream("Scadix.Designer.Fonts.Assets.OpenSans-Regular.ttf"), "resm:Scadix.Designer.Fonts.Assets.?assembly=Scadix.Designer#Open Sans");
