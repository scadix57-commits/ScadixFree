		...
		public void Move(Point p)
		{
			if (operation != null) {
				...
				if (operation.CurrentContainer.View != null && designPanel != null) {
					var tp1 = designPanel.TranslatePoint(p, operation.CurrentContainer.View);
					var tp2 = designPanel.TranslatePoint(startPoint, operation.CurrentContainer.View);
					v = (tp1 ?? p) - (tp2 ?? startPoint);
				} else {
					v = p - startPoint;
				}
